...
def send_alert_notification(field_id: str, alert_type: str, message: str, severity: str = 'normal'):
    """
...
def create_alert(field_id: str, alert_type: str, parameter: str, message: str, severity: str = 'normal') -> str:
    """
...
def get_user_alerts(user_id: str, unacknowledged_only: bool = False) -> List[Dict[str, Any]]:
...
def acknowledge_alert(alert_id: str, user_id: str) -> bool:
    ...
    try:
        ...
        # Verify ownership
        field = db.get_document('fields', alert.get('field_id'))
