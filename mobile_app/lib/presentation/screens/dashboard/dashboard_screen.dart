    ...
    return GridView.count(
      ...
      children: [
        ...
        SensorCard(
          ...
          unit: 'ppm',
          icon: Icons.grass,
          status: _getSensorStatus(sensorReading.nitrogen, 80, 150),
        ),
        SensorCard(
          title: 'Phosphorus (P)',
          ...
          status: _getSensorStatus(sensorReading.phosphorus, 20, 40),
        ),
        SensorCard(
          title: 'Potassium (K)',
          ...
          unit: 'ppm',
          icon: Icons.spa,
          status: _getSensorStatus(sensorReading.potassium, 100, 200),
        ),
        SensorCard(
          title: 'Moisture',
