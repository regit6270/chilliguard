...
def recommend_treatment(
    ...
    try:
        ...
        _ = field_id  # Reserved for future contextual recommendations
        ...
        primary: List[Dict[str, Any]] = disease_treatments.get('primary', [])
        alternative: List[Dict[str, Any]] = disease_treatments.get('alternative', [])
        preventive: List[Any] = disease_treatments.get('preventive', [])
...
def _get_treatment_database() -> Dict[str, Any]:
    ...
    return {'anthracnose_leaf_spot': {'primary': [{'name': 'Mancozeb 75% WP',
                                                   'type': 'chemical',
            ...
            'powdery_mildew': {'primary': [{'name': 'Sulfur 80% WP',
                                            'type': 'chemical',
                                            'dosage': '2-3g per liter water',
                                            'application': 'Spray at first sign of disease',
                                            'effectiveness': 'high',
                                            'cost_estimate': '₹300-500 per hectare'}],
                               'alternative': [{'name': 'Potassium Bicarbonate',
                                                'type': 'organic',
                                                'dosage': '5g per liter water',
            ...
            'healthy': {'primary': [],
                        'alternative': [],
                        'preventive': ['Continue regular monitoring',
...
def _get_general_advice(severity: str) -> str:
    ...
    return advice.get(
        severity,
        'Monitor the situation and apply recommended treatments.')
